...
> 概覽 / [工作流程](https://samwhelp.github.io/note-about-ubuntu-budgie/read/guide/workflow)

> [鍵盤按鍵綁定說明](https://samwhelp.github.io/note-about-ubuntu-budgie/read/config/keybind.html)

> 如何 / [設定「按鍵綁定」](https://samwhelp.github.io/note-about-ubuntu-budgie/read/howto/config-keybind.html)
...
> 在『[停用按鍵綁定「Super_L」開啟「Main Menu」](https://samwhelp.github.io/note-about-ubuntu-budgie/read/howto/disable-keybind-open-main-menu.html)』這篇有提到原本預設是綁定「`Super_L`」，只是這個設定，測試結果，只能設定單一按鍵。為了避免干擾，所以被我停用了。
...
| `Alt + Shift + t`  | 開啟 Terminal  | `gnome-terminal`   |
